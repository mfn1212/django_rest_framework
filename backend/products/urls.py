...
from .views import  product_alt_view, product_list_view, product_create_view, product_destroy_view, product_detail_view, product_listcreat_view, product_update_view
